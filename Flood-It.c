...
int main(int argc,char**argv){
  ...
  if (exo == 1)
     printf("%d changements de couleur", sequence_aleatoire_rec(M, G, dim, nbcl, aff)); 
  
  if (exo == 2)
	printf("%d changements de couleur", sequence_aleatoire_imp( M, G, dim, nbcl, aff));
  
  if (exo == 3)
	printf("%d changements de couleur", sequence_aleatoire_rapide( M, G, dim, nbcl, aff));
  
  if (exo == 4) mise_en_place(M, dim, nbcl);

  if (exo == 5) printf("%d changements de couleur", sequence_max_bordure(M, G, dim, nbcl, aff));

  if (exo == 6) printf("%d changements de couleur", sequence_parcours_largeur_puis_max_bordure(M, G, dim, nbcl, aff));
